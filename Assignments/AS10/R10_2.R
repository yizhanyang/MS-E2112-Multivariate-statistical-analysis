setwd('D:/Courses/Multivariable Statisitcal Analysis/AS10')
# We will use the MASS-library
library(MASS)

# First, we read the data

poll <- read.table("polls.txt",header=T,sep="\t",row.names=1)
View(poll)
...
# c) Perform the bottom up method? hierarchical clustering by hand. 
